const BottomGradientOverlay = () => {
  return (
    <div className="fixed bottom-0 left-0 w-full pointer-events-none <div className="fixed bottom-0 left-0 w-full pointer-events-none z-0 h-[140px] md:h-[160px] lg:h-[180px]"> h-[140px] md:h-[160px] lg:h-[180px]">
      {/* Main gradient */}
      <div
