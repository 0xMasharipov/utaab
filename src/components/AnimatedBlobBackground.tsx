const AnimatedBlobBackground = () => {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      {/* Blob 1 - Large blue */}
      <div
        className="absolute w-[500px] h-[500px] opacity-30 animate-blob-1"
        style={{
      ...
      <div
        className="absolute w-[400px] h-[400px] opacity-25 animate-blob-2"
        style={{
      ...
      {/* Blob 3 - Bright blue */}
      <div
        className="absolute w-[450px] h-[450px] opacity-20 animate-blob-3"
        style={{
      ...
      <div
        className="absolute w-[300px] h-[300px] opacity-20 animate-blob-4"
        style={{
